...
window.addClicktoEnlargeImages = function() {
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  Array.from(document.querySelectorAll(".hide-control")).forEach(function(item) {
    item.addEventListener("click", function(event) {
      ...
      let parentItem = event.target.closest(".collapsible-parent");
      if (parentItem) {
        parentItem.querySelector(".show-control").style.display = "block";
        parentItem.querySelector(".collapsible-item").style.display = "none";
      }
    });
  });

  Array.from(document.querySelectorAll(".show-control")).forEach(function(item) {
    item.addEventListener("click", function(event) {
      event.preventDefault();
      event.target.style.display = "none";
      let parentItem = event.target.closest(".collapsible-parent");
      if (parentItem) {
        parentItem.querySelector(".hide-control").style.display = "block";
